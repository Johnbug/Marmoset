...
<link rel="stylesheet" type="text/css" href="__CSS__/annouce_idx.css">
<script type="text/javascript" src = "__JS__/common.js"></script>
<script type="text/javascript" src = "__JS__/Annouce_idx.js"></script>
...
<body>
	...
	<div id = "frame">
		<div id = "nav">
			<div class = "icon" onclick = "window.location = '__APP__/Annouce/edit'">
			?</div>
			<div class = "icon" onclick = "window.location = '__APP__/Annouce/my_annoucement'">E</div>
			<div class = "icon">M</div>
		</div>
		<div id = "content">
			<div id = "message">
				<ul id = "mes_dialog">
				<?php if(is_array($aList)): $i = 0; $__LIST__ = $aList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><li><div class = "triangle"></div>
					<div class = "lHeader"><h3><?php echo ($list['annoucement']['title']); ?></h3></div>
					<div class = "lContent">
